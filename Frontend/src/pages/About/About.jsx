          ...
          <div class="items-center md:grid md:grid-cols-2 md:gap-8">
            <div class="mb-10 md:mb-0">
              ...
              <div class="mt-8 flex space-x-4">
                <button class="rounded-md bg-orange-500 px-6 py-3 font-medium text-white hover:bg-orange-600">
                  Start Shopping
                </button>
                <button class="border-primary-500 text-primary-500 hover:bg-primary-50 rounded-md border px-6 py-3 font-medium">
                  Watch Demo
                </button>
              </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="grid gap-8 text-center md:grid-cols-3">
            <div class="rounded-xl bg-gray-50 p-8">
              <h3 class="text-primary-500 text-5xl font-bold">10M+</h3>
              <p class="mt-2 font-medium text-gray-600">Happy Customers</p>
            </div>
            <div class="rounded-xl bg-gray-50 p-8">
              <h3 class="text-primary-500 text-5xl font-bold">50M+</h3>
              <p class="mt-2 font-medium text-gray-600">Products</p>
            </div>
            <div class="rounded-xl bg-gray-50 p-8">
              <h3 class="text-primary-500 text-5xl font-bold">99.9%</h3>
              <p class="mt-2 font-medium text-gray-600">Satisfaction</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="mb-12 text-center">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600">
              To make quality products accessible to everyone with an enjoyable,
          ...
          <div class="grid gap-8 md:grid-cols-3">
            <div class="rounded-xl bg-white p-8 shadow-sm">
              <div class="bg-primary-100 mb-6 flex h-14 w-14 items-center justify-center rounded-full">
                <svg
              ...
              <p class="text-gray-600">
                Free shipping on orders over 50 with express delivery available
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div class="text-center">
              ...
              />
              <h3 class="text-lg font-semibold text-gray-900">Karan Salvi</h3>
