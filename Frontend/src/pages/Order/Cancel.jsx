        ...
        <div class="bg-white rounded-sm shadow-sm overflow-hidden">
          ...
          <div class="bg-gray-50 p-6 md:p-8">
            <div class="flex justify-between items-center gap-1.5">
              <button class="w-full flex items-center justify-center px-6 py-2 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-medium transition-colors">
                Return to Cart
              </button>

             
                <button class="w-full px-6 py-2 rounded-lg border border-orange-500 text-orange-500 hover:bg-orange-50 font-medium transition-colors">
                  Continue Shopping
                </button>
